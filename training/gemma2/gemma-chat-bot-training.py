...
def run_training(number_of_dialogues, train_batch_size, eval_batch_size):
    ...
    training_arguments = TrainingArguments(
        output_dir="gemma2b-sales-chatbot",
...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            train_batch_size = gr.Number(label="Training batch size", value=3)
            eval_batch_size = gr.Number(label="Evaluation batch size", value=3)
